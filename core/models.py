...
class Product(models.Model):
    ...
    price = models.DecimalField(max_digits=99999999999999, decimal_places=2, default="1")
    old_price = models.DecimalField(max_digits=99999999999, decimal_places=2, default="2")
